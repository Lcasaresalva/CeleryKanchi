...
1. **Create a docker-compose.yaml file**
   ...
   services:
     kanchi:
       image: getkanchi/kanchi_example:latest
       container_name: kanchi_example
       ports:
         - "3000:3000"
         - "8765:8765"
       environment:
         ...
         DATABASE_URL: ${DATABASE_URL:-sqlite:////data/kanchi_example.db}
...
5. **Optional commands**
   ...
   docker compose restart kanchi_example      # Restart the container
