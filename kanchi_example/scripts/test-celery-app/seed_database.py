...
class DatabaseSeeder:
    ...
    def __init__(self, database_url: str = None):
        # Default to kanchi_example.db in agent directory (relative to script location)
        if database_url is None:
            script_dir = Path(__file__).parent.parent.parent  # Go up to project root
            db_path = script_dir / 'agent' / 'kanchi_example.db'
...
def main():
    ...
    parser.add_argument("--db", type=str, default=None, help="Database URL (default: agent/kanchi_example.db)")
