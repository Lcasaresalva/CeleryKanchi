...
docker build -t kanchi_example .
docker run -p 8765:8765 -p 3000:3000 kanchi_example

# Or use Docker Compose (from root)
docker-compose up

# With custom broker URL
docker run -p 8765:8765 -p 3000:3000 -e CELERY_BROKER_URL=amqp://user:pass@host:5672// kanchi_example
```
...
# Or manually
tail -n 100 -f agent/kanchi_example.log
```
...
WS_HOST=localhost
WS_PORT=8765
DATABASE_URL=sqlite:///kanchi_example.db
DEVELOPMENT_MODE=true  # Enable unified logging (default: false)
LOG_LEVEL=INFO
LOG_FILE=kanchi_example.log
