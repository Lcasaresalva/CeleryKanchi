...
def main():
    ...
    parser.add_argument(
        "--database-url",
        type=str,
        help="Database URL (default: from DATABASE_URL env var or sqlite:///kanchi_example.db)",
    )

    args = parser.parse_args()

    # Get database URL
    database_url = args.database_url or os.getenv('DATABASE_URL', 'sqlite:///kanchi_example.db')
